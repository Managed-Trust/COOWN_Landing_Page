...
//   };
//   public func main1(id : Account__1) : async Nat {
//     let cowsay = actor ("hbjjz-kaaaa-aaaan-qiocq-cai") : actor {
...
//   };
//   public func main2(id : TransferType) {
//     let cowsay = actor ("hbjjz-kaaaa-aaaan-qiocq-cai") : actor {
//       icrc1_transfer : (TransferType) -> async ();
//     };
//     let datastore = await cowsay.icrc1_transfer(id);
